...
<body class="nav-md">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="<?php echo base_url();?>assets/images/sttb.jpg" alt="..." class="img-circle profile_img">
                        </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url();?>assets/images/sttb.jpg" alt=""><?php echo $nama_usr?>
    ...
    <?php $this->load->view($content);?>
                ...
                <footer>
                    <div class="">
                        <p class="pull-right">Laundry masa kini |
